...
public interface MetadataRegistrationEventsType extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.sdmx.resources.sdmxml.schemas.v30.registry.MetadataRegistrationEventsType> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s8F117A22AAF2566D69780D55C438B5BD.TypeSystemHolder.typeSystem, "metadataregistrationeventstype5f87type");
     ...
     */
    java.util.List<org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType> getMetadataflowReferenceList();

    /**
     * Gets array of all "MetadataflowReference" elements
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType[] getMetadataflowReferenceArray();

    /**
     * Gets ith "MetadataflowReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType getMetadataflowReferenceArray(int i);
     ...
     */
    void setMetadataflowReferenceArray(int i, org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType metadataflowReference);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "MetadataflowReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType insertNewMetadataflowReference(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "MetadataflowReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType addNewMetadataflowReference();
     ...
     */
    java.util.List<org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType> getMetadataStructureDefinitionReferenceList();

    /**
     * Gets array of all "MetadataStructureDefinitionReference" elements
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType[] getMetadataStructureDefinitionReferenceArray();

    /**
     * Gets ith "MetadataStructureDefinitionReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType getMetadataStructureDefinitionReferenceArray(int i);
     ...
     */
    void setMetadataStructureDefinitionReferenceArray(int i, org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType metadataStructureDefinitionReference);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "MetadataStructureDefinitionReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType insertNewMetadataStructureDefinitionReference(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "MetadataStructureDefinitionReference" element
     */
    org.sdmx.resources.sdmxml.schemas.v30.registry.MaintainableEventType addNewMetadataStructureDefinitionReference();
