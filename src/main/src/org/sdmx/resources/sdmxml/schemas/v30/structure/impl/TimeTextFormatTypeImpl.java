 ...
 */
public class TimeTextFormatTypeImpl extends org.sdmx.resources.sdmxml.schemas.v30.structure.impl.SimpleComponentTextFormatTypeImpl implements org.sdmx.resources.sdmxml.schemas.v30.structure.TimeTextFormatType {
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.common.DataType xgetTextType() {
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.common.DataType)get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
