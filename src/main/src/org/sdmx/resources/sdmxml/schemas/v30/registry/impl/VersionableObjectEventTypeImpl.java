 ...
 */
public class VersionableObjectEventTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v30.registry.VersionableObjectEventType {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://www.sdmx.org/resources/sdmxml/schemas/v3_0/registry", "Version"),
    };
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.registry.VersionQueryType xgetVersion() {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.registry.VersionQueryType)get_store().find_element_user(PROPERTY_QNAME[3], 0);
            return target;
        }
    }
    ...
    public void xsetVersion(org.sdmx.resources.sdmxml.schemas.v30.registry.VersionQueryType version) {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.registry.VersionQueryType)get_store().find_element_user(PROPERTY_QNAME[3], 0);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.registry.VersionQueryType)get_store().add_element_user(PROPERTY_QNAME[3]);
            }
            target.set(version);
        }
    }
