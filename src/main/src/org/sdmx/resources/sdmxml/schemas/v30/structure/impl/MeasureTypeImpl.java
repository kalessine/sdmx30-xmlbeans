 ...
 */
public class MeasureTypeImpl extends org.sdmx.resources.sdmxml.schemas.v30.structure.impl.MeasureBaseTypeImpl implements org.sdmx.resources.sdmxml.schemas.v30.structure.MeasureType {
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType xgetUsage() {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType)get_default_attribute_value(PROPERTY_QNAME[1]);
            }
            return target;
        }
    }
    ...
    public void xsetUsage(org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType usage) {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.structure.UsageType)get_store().add_attribute_user(PROPERTY_QNAME[1]);
            }
            target.set(usage);
        }
    }
