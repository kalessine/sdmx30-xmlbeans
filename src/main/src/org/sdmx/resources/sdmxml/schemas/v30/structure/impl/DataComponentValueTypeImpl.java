/*
 * XML Type:  DataComponentValueType
 * Namespace: http://www.sdmx.org/resources/sdmxml/schemas/v3_0/structure
 * Java type: org.sdmx.resources.sdmxml.schemas.v30.structure.DataComponentValueType
 *
...
/**
 * An XML DataComponentValueType(@http://www.sdmx.org/resources/sdmxml/schemas/v3_0/structure).
 *
 * This is an atomic type that is a restriction of org.sdmx.resources.sdmxml.schemas.v30.structure.DataComponentValueType.
 */
public class DataComponentValueTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.sdmx.resources.sdmxml.schemas.v30.structure.DataComponentValueType {
    private static final long serialVersionUID = 1L;

    public DataComponentValueTypeImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType, true);
    }

    protected DataComponentValueTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b) {
        super(sType, b);
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType xgetValidFrom() {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().find_attribute_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
    ...
    public void xsetValidFrom(org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType validFrom) {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().add_attribute_user(PROPERTY_QNAME[0]);
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType xgetValidTo() {
        synchronized (monitor()) {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
    ...
    public void xsetValidTo(org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType validTo) {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.common.StandardTimePeriodType)get_store().add_attribute_user(PROPERTY_QNAME[1]);
            }
            target.set(validTo);
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType xgetCascadeValues() {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType)get_default_attribute_value(PROPERTY_QNAME[2]);
            }
            return target;
        }
    }
    ...
    public void xsetCascadeValues(org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType cascadeValues) {
        synchronized (monitor()) {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (org.sdmx.resources.sdmxml.schemas.v30.common.CascadeSelectionType)get_store().add_attribute_user(PROPERTY_QNAME[2]);
            }
